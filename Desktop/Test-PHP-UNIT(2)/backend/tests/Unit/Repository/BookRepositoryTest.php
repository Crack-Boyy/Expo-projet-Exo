<?php
namespace App\Tests\Unit\Repository\BookRepositoryTest;
...
class BookRepositoryTest extends WebTestCase
{
    ...
    public function testGetBooksCollection(): void
    {
        ...
        // Correction: enlever le saut de ligne et vérifier plus souplement
    ...
    public function testGetBookItem(): void
    {
        ...
        // Correction: vérification plus souple du content-type
        $contentType = $client->getResponse()->headers->get('content-type');
        $this->assertStringContainsString('application/ld+json', $contentType);
